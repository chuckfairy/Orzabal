...
#define SUIL_WITH_GTK2_IN_QT4 1
#define SUIL_WITH_QT4_IN_GTK2 1
#define SUIL_WITH_GTK2_IN_QT5 1
#define SUIL_WITH_X11_IN_GTK2 1
#define SUIL_WITH_X11_IN_QT4 1
#define SUIL_WITH_X11_IN_QT5 1
